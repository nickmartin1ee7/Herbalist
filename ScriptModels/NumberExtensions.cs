public static class NumberExtensions
{
    ...
    {
        const long Septillion = 1_000_000_000_000_000_000;
        const long Sextillion = 1_000_000_000_000_000;
        const long Quintillion = 1_000_000_000_000;
        const long Quadrillion = 1_000_000_000;
        const long Trillion = 1_000_000_000;
        ...
        {
            return $"{(double)number / Septillion:F2} Sept";
        }
        else if (number >= Sextillion)
        {
            return $"{(double)number / Sextillion:F2} Sext";
        }
